...
model_1 = model_1.fit(Xtrain,ytrain)
prediction_1 = model_1.predict(Xtest)
print (confusion_matrix(ytest, prediction_1) )
print (accuracy_score(ytest,prediction_1))
print(precision_score(ytest,prediction_1))
fpr, tpr, threshold = metrics.roc_curve(ytest, prediction_1)
